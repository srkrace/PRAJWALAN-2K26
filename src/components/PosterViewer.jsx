        ...
        <section className="min-h-screen pt-24 pb-12 px-4 md:px-8">
            <div className="container mx-auto max-w-5xl">
                ...
                >
                    ...
                    <p className="text-gray-400 font-rajdhani text-lg">Event Poster</p>
                </motion.div>
                ...
                <div className="flex justify-center">
                    <motion.div
                        ...
                        className="relative rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(139,92,246,0.3)] border border-violet-500/20 max-w-3xl w-full"
                    >
                        <img
                            src="https://res.cloudinary.com/domogztsv/image/upload/v1769363185/IMG_0836.JPG_kypise.jpg"
                            alt="Prajwalan 2K26 Poster"
