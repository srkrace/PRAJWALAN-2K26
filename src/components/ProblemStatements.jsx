        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <div
                        className={`absolute inset-0 bg-gradient-to-r from-violet-600/0 via-violet-600/8 to-violet-600/0 transition-transform duration-1000 ${isHovered ? 'translate-x-full' : '-translate-x-full'}`}
                    />
                    ...
                    <div className="relative glass-panel p-10 border border-violet-500/30 backdrop-blur-md bg-gradient-to-br from-violet-900/20 via-black/40 to-purple-900/20 overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-orbitron text-sm tracking-wider transition-all duration-300 shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:shadow-[0_0_50px_rgba(139,92,246,0.6)] group/btn relative overflow-hidden"
                            >
                                <motion.div
